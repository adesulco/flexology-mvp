         ...
         <div className="bg-white border text-sm border-gray-200 rounded-2xl w-full p-6 shadow-sm mb-6 text-left">
            ...
            <div className="space-y-4 mb-6">
               <div className="flex justify-between items-center text-gray-600">
                  ...
                  <span className="font-mono text-sm">IDR {(transaction.subtotal / 1000).toLocaleString()}K</span>
               </div>
               <div className="flex justify-between items-center text-gray-600">
                  <span className="font-bold text-sm">Gateway Tax ({transaction.method})</span>
                  <span className="font-mono text-sm">IDR {(transaction.platformFee / 1000).toLocaleString()}K</span>
               </div>
            </div>
            ...
            <div className="flex justify-between items-center pt-4 border-t border-gray-100 mb-2">
               ...
               <span className="font-mono text-xl text-emerald-600 font-bold">IDR {(transaction.totalAmount / 1000).toLocaleString()}K</span>
            </div>
         </div>
